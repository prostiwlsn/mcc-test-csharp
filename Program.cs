...
class Program
{
    static void Main(string[] args)
    {
        ...
        */
        ...
        Console.WriteLine(
             JsonSerializer.Serialize(NumberOfCommentsPerUser(context)));
        ...
        */
        ...
        Console.WriteLine(
             JsonSerializer.Serialize(PostsOrderedByLastCommentDate(context)));
        ...
        */
        ...
        Console.WriteLine(
             JsonSerializer.Serialize(NumberOfLastCommentsLeftByUser(context)));
